...
Name:           ros-humble-rmw-int2dds-cpp
Version:        0.1.0
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS rmw_int2dds_cpp package

License:        Apache-2.0
URL:            https://github.com/IntellectusCorp/int2DDS
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-int2dds-ffi-vendor
...
BuildRequires:  ros-humble-int2dds-ffi-vendor
...
%description
ROS 2 middleware (RMW) implementation that binds the int2DDS DDS/RTPS middleware
to the ROS 2 rmw interface.
